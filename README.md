...
*   **🌐 中英双语 + 双币种：** 一键切换中文/English，人民币与美元的默认参考价格、预算范围各自独立校准，不是简单换算符号。
...
2. **配置：** 输入本月预算总额（可在页面顶部切换中文/English 与对应币种）。
...
> **Zero-Dependency · Local-First · Mobile-First · Bilingual**

*   **⚡️ Zero-Dependency:** Core libraries are embedded; no concerns about CDN latency or downtime.
*   **🌐 Bilingual + Multi-Currency:** Switch between Chinese/English with one tap. Reference prices and budget ranges are independently calibrated for CNY and USD, not just a symbol swap.
...
2. **Budget:** Set your total monthly budget (toggle Chinese/English and the matching currency at the top of the page).
...
| :--- | :--- |
| **数据持久化 (localStorage)** | ✅ Done |
| **中英双语界面 (Bilingual UI)** | ✅ Done |
| **多币种支持 (Multi-currency, CNY/USD)** | ✅ Done |
